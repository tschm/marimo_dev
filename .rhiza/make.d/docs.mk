...
# API docs are rendered via mkdocstrings (replaces pdoc).
...
# 3. Builds the static site using mkdocs with material theme, mkdocstrings, and mkdocs-jupyter.
